// src/pages/DocumentationPage.tsx — Vanessa
...
const GROUPS: Group[] = [
    ...
    },
    {
        ...
        sections: [
            {
                title: 'Qui est Vanessa ?',
                content:
                    "Vanessa est l'IA qui donne son nom à la plateforme — une personnalité au langage de rue, pas un assistant classique. Discute avec elle en texte ou en vocal, envoie-lui une photo, elle réagit avec humour tout en restant sérieuse sur les sujets sensibles.",
            },
            {
                title: 'Ses humeurs',
                content:
        ...
        <div className="min-h-screen bg-gray-50 px-4 py-8">
            <div className="max-w-2xl mx-auto space-y-4">
                ...
                <div className="bg-white rounded-3xl p-6 space-y-2">
                    <h1 className="text-xl font-bold text-gray-800">Comment fonctionne Vanessa</h1>
                    <p className="text-sm text-gray-400">« Celle qui vous ressemble et vous rassemble »</p>
                </div>
